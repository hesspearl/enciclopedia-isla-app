...
import subjects,{cards} from "../data/subjects.ts";
import SubjectSection from '../components/SubjectsSection.tsx';
    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 md:py-32">
          ...
          >
            ...
            <motion.div
              ...
              style={{ background: 'linear-gradient(to bottom right, #06342a, #08493a)' }}
            >
            ...
            >
              Enciclopédia da{' '}
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: 'linear-gradient(to right, #06342a, #08493a)', WebkitBackgroundClip: 'text', backgroundClip: 'text' }}>
                Luz de Allah
              </span>
            </motion.h1>
            ...
            >
              Sua jornada de conhecimento começa aqui. Aprenda sobre o Islam de forma
              guiada, clara e acolhedora.
            </motion.p>
            ...
            <motion.div
              ...
              style={{ color: '#06342a' }}
            >
              <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: '#06342a' }} />
      ...
      <main className="max-w-7xl mx-auto px-6 pb-24">
        { subjects.length === 0 ? (
          ...
          >
            <div className="w-24 h-24 mx-auto mb-6 rounded-full flex items-center justify-center" style={{ backgroundColor: '#d1f0e8' }}>
          ...
          subjects.map((subject) => (
            <SubjectSection
             ...
             cards={cards.filter(card=>card.subject_id===subject.id)}
